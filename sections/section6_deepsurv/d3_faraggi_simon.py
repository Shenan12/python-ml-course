...
| **no dropout** (invented 2012), **no batch norm** (2015) | both, tuned | Small survival datasets (WHAS: 1,638 units) and a flexible model = overfitting. Without modern regularizers, a neural net memorises and generalises worse than a rigid linear model. |
